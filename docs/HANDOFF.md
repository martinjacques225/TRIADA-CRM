...
> - **⬜ Falta:** abrirlo **logueado** en el CRM real. La base ya acepta las escrituras y la RLS está probada, pero **el camino desde la interfaz —guardar, crear la oportunidad, agendar el seguimiento— no se ha ejecutado con una sesión de usuario**. También falta el deploy a Pages y la paridad móvil (`movil/`).
