...
- **Compartir propuesta** (el botón "Compartir" de la propuesta sigue siendo stub). La **Cotización PDF YA está hecha (2026-06-25)** → `movil/js/cotizacion.js`: A4 con marca Tríada (reutiliza el scaffolding del Informe 360), datos de contacto del lead, ítems, IVA y Términos y condiciones; "Descargar PDF" = `window.print()`. Verificada con PDF A4 real (Chrome headless).
